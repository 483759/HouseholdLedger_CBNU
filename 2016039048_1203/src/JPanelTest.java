...
class JPanel01 extends JPanel { 
	...
	public JPanel01(JPanelTest win) {
		...
		ImageIcon img = new ImageIcon("C:\\Users\\김한별\\Desktop\\제목 없음.png");
		JLabel lb = new JLabel(img);
		lb.setBounds(0,0,800,90);
		add(lb);
	 ...
	 */
	abstract class labelimage extends JFrame implements Runnable, ActionListener{
		ImageIcon img;
		JLabel lb;
